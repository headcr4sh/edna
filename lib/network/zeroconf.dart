...
import 'package:provider/provider.dart' show FutureProvider;
      ...
      if (service.type == _serviceType && service.name == _serviceName) {
        switch (status) {
          ...
          default:
            ...
            // is most likely not relevant or can be handled.
            break;
        }
      }
    });
...
class _ServerZeroconfManager extends _ClientZeroconfManager {
  ...
  _ServerZeroconfManager(final nsd.Discovery discovery, final nsd.Registration registration):
