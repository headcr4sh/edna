...
enum EdnaAppMode {
  ...
  /// Default mode to run in if nothing else has been specified.
  /// Usually just falls back to client mode.
  static EdnaAppMode defaultForCurrentPlatform() => Platform.isWindows ? EdnaAppMode.server : EdnaAppMode.client;
