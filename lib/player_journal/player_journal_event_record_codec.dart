...
class PlayerJournalEventRecordConversionSink extends StringConversionSinkBase {
  ...
  @override
  void addSlice(final String str, final int start, final int end, final bool isLast) {
    _output.add(PlayerJournalEventRecord.fromString(str.substring(start, end)));
  }
...
class PlayerJournalEventRecordDecoder extends Converter<String, PlayerJournalEventRecord> {
  @override
  PlayerJournalEventRecord convert(line) => PlayerJournalEventRecord.fromString(line);
